...
require("colors");
var _scheduleJob = require("./utils/backup/scheduleJob");
...
// cookie parser
app.use((0, _cookieParser["default"])(_config.config.jwt.refreshSecret));
...
// enable CORS
app.use(_cors.configCors);

// jwt authentication
app.use(_passport["default"].initialize());
_passport["default"].use('jwt', _config.jwtStrategy);

// Set static folder
app.use(_express["default"]["static"](_path["default"].join(__dirname, 'src', 'uploads')));

// Init schedule job
(0, _scheduleJob.scheduleJob)();
