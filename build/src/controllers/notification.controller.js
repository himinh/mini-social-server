...
exports.updateNotification = exports.updateMany = exports.getNotifications = exports.getNotificationLatest = exports.getNotification = exports.deleteNotification = exports.createNotification = exports.count = void 0;
...
var getNotificationLatest = (0, _catchAsync["default"])( /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _services.notificationService.getNotification({
              userTo: req.user.id
            });
          case 2:
 ...
 * @access private
 */
exports.getNotificationLatest = getNotificationLatest;
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            filter = (0, _pick["default"])(req.query, ['opened']); // Filter by opened
            if (filter.opened) {
              // convert string to boolean
              filter.opened = JSON.parse(filter.opened);
            }
            filter.userTo = req.user.id;
            _context6.next = 5;
            return _services.notificationService.updateMany(filter, req.body);
          case 5:
