      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 6;
            return _services.userService.updateById(userId, (_userService$updateBy = {}, (0, _defineProperty2["default"])(_userService$updateBy, options, {
              followers: user.id
            }), (0, _defineProperty2["default"])(_userService$updateBy, "$inc", {
              numberFollowers: isFollowing ? -1 : 1
            }), _userService$updateBy));
          case 6:
